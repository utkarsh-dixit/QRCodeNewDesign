...
namespace QRCoder
{
    ...
    public class QRCode : AbstractQRCode<Bitmap>, IDisposable
    {
        ...
        public Bitmap GetGraphic(int pixelsPerModule, Color darkColor, Color lightColor, int design, Bitmap icon=null, int iconSizePercent=15, int iconBorderWidth = 6, bool drawQuietZones = true)
        {
            ...
            Color bottomTopColor = Color.FromArgb(67,59,57);
            String backgroundImage = "assets/6.1.green.png";
            String cornorImage = "assets/first_bot.png";
            String cornor2Image = "assets/greenbotoom2.png";
           if (design == 1)
            {
                ...
                bottomTopColor = Color.FromArgb(96, 86, 84);
                cornor2Image = "assets/blueBottom2.png";
                //1
            ...
            else if(design==2)
            {
                ...
                bottomTopColor = Color.FromArgb(80, 71,52);
                cornor2Image = "assets/orangebottom2.png";
                // 2
            }
           else if (design == 3)
            {
                ...
                bottomTopColor = Color.FromArgb(72, 63, 61);
                cornor2Image = "assets/grayBottom2.png";
            }
            var size = (this.QrCodeData.ModuleMatrix.Count - (drawQuietZones ? 0 : 8)) * pixelsPerModule;
            var offset = drawQuietZones ? 0 : 4 * pixelsPerModule;
                    ...
                    if (module)
                    {
                        ...
                        var r = new Rectangle((x*t)-offset, (y*t)-offset, pixelsPerModule-offSetP, pixelsPerModule-offSetP);
                            ...
                            else
                            {
                                ...
                                ll = new Rectangle((int)(centerDest.X - 47), (int)((centerDest.Y - 8)), 540, 540);
                                if (Math.Pow((ll.Left + ll.Right) / 2 - (r.Left + r.Right) / 2, 2) + Math.Pow((ll.Top + ll.Bottom) / 2 - (r.Top + r.Bottom) / 2, 2) <= Math.Pow(ll.Width / 2, 2))
                                {
                                    // Top Right Larger
                                    System.Drawing.Color col = topRightLargeColor;
                                    var sr = new SolidBrush(col);
                                   // gfx.FillEllipse(sr, ll);
                                    gfx.FillEllipse(sr, r);
                                }
                                else
                                {
        ...
        public Bitmap GetGraphicQR(int pixelsPerModule, Color darkColor, Color lightColor, int design, Bitmap icon = null, int iconSizePercent = 15, int iconBorderWidth = 6, bool drawQuietZones = true)
        {
